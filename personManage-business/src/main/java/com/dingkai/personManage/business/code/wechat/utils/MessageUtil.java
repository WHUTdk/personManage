...
public class MessageUtil {
	 ...
	 * 文本消息对象转换成xml
	 */
	public static String textMessageToXml(TextRespMsg textMessage) {
	 ...
	 * 图片消息对象转换成xml
	 */
	public static String imageMessageToXml(ImageRespMsg imageMessage) {
		xstream.alias("xml", imageMessage.getClass());
		xstream.alias("Image", new ImageRespMsg.Image().getClass());
