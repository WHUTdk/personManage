...
public class PicUtil {
    ...
    private static final int readTimeout = 530000;
     ...
     * 将http链接图片转为base64
     */
    public static String picToBase64ByHttp(String httpURL) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String base64 = picToBase64ByHttp(url1);
